...
int MapBuilderBridge::AddTrajectory(
    ...
    const TrajectoryOptions& trajectory_options) {
    	// 这里调用cartographer里面 AddTrajectoryBuilder
...
// 得到冻结之后的轨迹id， 
//需要调用map_builder_->pose_graph()->GetTrajectoryNodePoses()和map_builder_->pose_graph()->IsTrajectoryFrozen(trajectory_id)来处理
